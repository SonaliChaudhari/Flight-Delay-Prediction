...
def result():
	...
	url = 'https://ussouthcentral.services.azureml.net/workspaces/c2f8dc5126ac4024b08690eda8426a56/services/56aec1d6d4cf4e9f8417725bc30368a7/execute?api-version=2.0&format=swagger'
	api_key = '1nXBFGTfd3TGW6QkqfYfIO6kx91QThbcMBeeDZ8/I6vkrLZzb87+L1QojRRAkccByUyCz6ZnlRJOUQBRYb25Hw==' # Replace this with the API key for the web service
	...
	status = result['Results']['output1'][0]['Scored Label Mean']
